...
//        System.out.println("\n--------------------------------------------------------------------------------\n");
        ...
        //libraryDbService.addBooks(textbook1, textbook2, textbook3);
...
//        libraryDbService.addBooks(dict1, dict2);
//
...
//        libraryCsvService.addBooks(test1, test2);
//        libraryCsvService.getAuthorsWithAutobiography().forEach((key,value) -> System.out.println(key+" -> "+value));
...
//        libraryDbService.addBooks(test1, test2, bio);
//
